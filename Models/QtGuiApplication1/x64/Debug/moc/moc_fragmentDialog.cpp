...
struct qt_meta_stringdata_fragmentDialog_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_fragmentDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_fragmentDialog_t qt_meta_stringdata_fragmentDialog = {
    {
QT_MOC_LITERAL(0, 0, 14) // "fragmentDialog"
...
const QMetaObject fragmentDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_fragmentDialog.data,
      qt_meta_data_fragmentDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *fragmentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_fragmentDialog.stringdata0))
