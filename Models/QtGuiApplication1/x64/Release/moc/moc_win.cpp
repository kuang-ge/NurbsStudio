...
const QMetaObject win::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_win.data,
      qt_meta_data_win,  qt_static_metacall, nullptr, nullptr}
};
...
void *win::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions_4_5_Core"))
        return static_cast< QOpenGLFunctions_4_5_Core*>(const_cast< win*>(this));
