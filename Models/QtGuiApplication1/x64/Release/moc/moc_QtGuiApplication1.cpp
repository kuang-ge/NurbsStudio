...
QT_MOC_LITERAL(1, 18, 8), // "slotTest"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(4, 45, 3), // "in1"
QT_MOC_LITERAL(5, 49, 3), // "in2"
QT_MOC_LITERAL(6, 53, 11) // "slotChanged"

    },
    "QtGuiApplication1\0slotTest\0\0"
    "QTreeWidgetItem*\0in1\0in2\0slotChanged"
};
...
void QtGuiApplication1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotTest((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->slotChanged((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
